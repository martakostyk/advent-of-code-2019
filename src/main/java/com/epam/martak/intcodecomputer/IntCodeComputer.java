...
public class IntCodeComputer {
    ...
    public static void main(String[] args) {
        int[] inputIntCode = new int[]{
                ...
                2, 6, 51, 55, 1, 5, 55, 59, 2, 9, 59, 63, 2, 6, 63, 67, 1, 13, 67, 71, 1, 9, 71, 75, 2, 13,
                75, 79, 1, 79, 10, 83, 2, 83, 9, 87, 1, 5, 87, 91, 2, 91, 6, 95, 2, 13, 95, 99, 1, 99, 5, 103,
                1, 103, 2, 107, 1, 107, 10, 0, 99, 2, 0, 14, 0};
        inputIntCode[1] = 12;
        inputIntCode[2] = 2;
        int[] result = new IntCodeComputer().execute(inputIntCode);
